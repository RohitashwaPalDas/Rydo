...
const FinishRide = (props) => {
    ...
    async function endRide() {
        const response = await axios.post(backEndUrl+"/api/ride/end-ride", {
                ...
                <div className='w-full mt-5'>
                    ...
                    <div className='flex items-center gap-5 p-3'>
                        ...
                        <div>
                            ...
                            <p className='text-sm -mt-1 text-gray-600'>Cash Cash {props.paymentSts?"(Paid)":"(Unpaid)"}</p>
                        </div>
                    </div>
                </div>
